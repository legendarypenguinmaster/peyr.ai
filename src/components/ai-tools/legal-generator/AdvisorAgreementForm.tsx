...
export default function AdvisorAgreementForm({ companyInfo, updateCompanyInfo }: AdvisorAgreementFormProps) {
  return (
    <>
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">Advisor Role *</label>
        <input
          type="text"
      ...
      <div className="md:col-span-2">
        <label className="block text-sm font-medium text-gray-700 mb-2">Advisor Address</label>
        <textarea
