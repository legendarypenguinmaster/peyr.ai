...
export default function EmploymentContractForm({ companyInfo, updateCompanyInfo }: EmploymentContractFormProps) {
  return (
    <>
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Employee Role *</label>
        <input
          type="text"
      ...
      <div className="md:col-span-2">
        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Employee Address</label>
        <textarea
