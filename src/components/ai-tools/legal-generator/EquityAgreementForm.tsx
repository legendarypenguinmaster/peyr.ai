...
export default function EquityAgreementForm({ companyInfo, updateCompanyInfo }: EquityAgreementFormProps) {
  return (
    <>
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Stock Options *</label>
        <input
          type="text"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Exercise Price *</label>
        <input
          type="text"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Grant Date *</label>
        <input
          type="date"
