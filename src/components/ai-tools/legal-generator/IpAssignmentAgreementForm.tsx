...
export default function IpAssignmentAgreementForm({ companyInfo, updateCompanyInfo }: IpAssignmentAgreementFormProps) {
  return (
    <>
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">IP Owner *</label>
        <input
          type="text"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">IP Assignee *</label>
        <input
          type="text"
      ...
      <div className="md:col-span-2">
        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">IP Description *</label>
        <textarea
      ...
      <div className="md:col-span-2">
        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Assignment Scope *</label>
        <textarea
