...
export default function NonDisclosureAgreementForm({ companyInfo, updateCompanyInfo }: NonDisclosureAgreementFormProps) {
  return (
    <>
      ...
      {/* NDA Specific Fields */}
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">Disclosing Party *</label>
        <input
          type="text"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">Receiving Party *</label>
        <input
          type="text"
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">Disclosure Period</label>
        <select
