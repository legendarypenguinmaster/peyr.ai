...
export default function ProjectDetail({
  ...
  useEffect(() => {
    const applyHash = () => {
      ...
      if (hash && (allowed as string[]).includes(hash))
  ...
  return (
    <div className="max-w-7xl mx-auto">
          ...
          <div className="flex -space-x-2">
            {members.slice(0, 5).map((m) => (
              <div
                ...
                className="w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-xs font-semibold text-gray-700 dark:text-gray-200 border border-white dark:border-gray-800"
              >
      ...
      {activeTab === "trust" && <TrustTab projectId={projectId} />}
    </div>
  );
}
